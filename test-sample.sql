...
FROM Items
WHERE Items.id = 3 AND (CURRENT_DATE >= expiration_date - INTEGER '3')
ORDER BY expiration_date ASC, name ASC) AS T1)
SELECT DISTINCT AvailableRecipes.name, cuisine, ingredient1, ingredient2, ingredient3, ingredient4, ingredient5
